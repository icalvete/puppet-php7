class php7::php7_cli::config {
  ...
  augeas{'include_path_cli' :
    context => "/files${php7::php7_cli_phpini}/PHP",
    changes => "set include_path .:${php7::php7_includepath}:${php7::php7_includepath}/7.${php7::version}/cli",
  }
  ...
  file {'cli_maxminddb_config':
    ...
    path    => "${php7::php7_cli_phpconf}/20-maxminddb.ini",
  ...
  if "${php7::version}" == '2' {
    file_line { "${php7::php7_cli_phpini}":
      path  => "${php7::php7_cli_phpini}",
